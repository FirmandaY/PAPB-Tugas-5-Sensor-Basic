...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLighSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_LIGHT);
    ...
    protected void onStart() {
        ...
        if (mLighSensor != null){
            mSensorManager.registerListener(this, mLighSensor, SensorManager.SENSOR_DELAY_NORMAL);
        }
